...
if(CLANG_TIDY)
    ...
    if(ENABLE_BUILD_LINT_CLANG_TIDY)
        set(CMAKE_CXX_CLANG_TIDY "${CLANG_TIDY}" -extra-arg=-std=c++23)
    endif()
else()
...
if(ENABLE_BUILD_LINT_IWYU)
    ...
    if(IWYU)
        ...
        set(CMAKE_CXX_INCLUDE_WHAT_YOU_USE "${IWYU}" -std=c++23 -Xiwyu --cxx17ns -Xiwyu --no_fwd_decls -Xiwyu "--mapping_file=${CMAKE_SOURCE_DIR}/.iwyu_mappings.imp")
    else()
